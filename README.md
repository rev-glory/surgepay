# surgepay
Production-inspired event-driven payment orchestration platform built with NestJS, TypeScript, Kafka-compatible messaging (Redpanda), PostgreSQL, Redis, Docker, and OpenTelemetry to demonstrate reliable distributed payment processing using Saga orchestration, Transactional Outbox, Inbox pattern, and eventual consistency.
